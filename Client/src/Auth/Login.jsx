         ...
         <div className='w-2/5 h-9/12 bg-sky-900 rounded-l-3xl bg-sky-900'>
            ...
            <div className=' w-3/5 bg-primary rounded-r-3xl'> 
              ...
              <div><h3 className='text-xl text-white py-2    font-bold'>Welcome To SmartShipHub</h3></div>
                 ...
                 <div><p className='text-xs w-40 text-white py-2 '>Welcome back Please login to Your account</p></div>
                 ...
                 <div className=''><input type="text" 
                                   ...
                                   ></input></div>
                 <div className='text-xs text-red-700 py-2'>Forget Password ?</div>
                 <div className='my-4'>
                     <button type='submit' className=' hover:bg-green-700 bg-green-600 rounded-2xl px-6 w-9/12 h-8 text-white text-xs py-2  w'>Login</button>
            ...
            <div className=" w-3/5 bg-primary rounded-r-3xl">
              <div className="py-12 px-16 ">
                ...
                <div className="my-4">
                  ...
                  <div className="text-red-800 py-2">New User ?</div>
>>>>>>> de7312e9eb5356acf4621e8ee756692a6c17b0f5
                </div>
              </div>
            </div>
          </div>
