...
export  const UserRegister = () => {
  return (
    <div className='h-screen w-screen bg-secondary-light relative'>
      <div className='bg-secondary-dark my-16 mx-10 h-4/5 lg:3/4 w-3/4 inline text-center  absolute  lg:mx-32 lg:rounded-xl '>
    <div className=' inline lg:my-8'>
      <div className='inline'><h3 className='font-bold text-xs text-red-900 mx-4 my-4 lg:text-red-700 lg:text-2xl lg:text-center lg:my'><img src='../public/Images/smartship2.png' className='mx-4 lg:mx-60' alt='smartship'></img></h3></div>
      <div className='inline'><p className='text-xs px-4  my-2 text-red-600 lg:w-72 lg:text-red-600'>Fill Your Detailes*</p></div>
